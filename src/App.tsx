  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-columbia_blue-600 to-columbia_blue-800">
      ...
      <section id="services" className="py-0">
        ...
        <div className="bg-black flex flex-col items-start pl-12 pr-8 py-12 min-h-[400px] border-b-4 md:border-b-0 md:border-r-4 border-lime-400">
            {/*For Companies */}
            <h3 className="text-5xl md:text-6xl font-bold text-white mb-6" style={{fontFamily: 'Inter, Helvetica, Arial, sans-serif'}}>For Companies</h3>
          ...
          {/* For Candidates */}
          <div className="bg-gradient-to-b from-blue-600 to-cyan-400 flex flex-col items-start pl-12 pr-8 py-12 min-h-[400px] border-b-4 md:border-b-0 md:border-l-4 border-blue-500">
            <h3 className="text-5xl md:text-6xl font-bold text-white mb-6" style={{fontFamily: 'Inter, Helvetica, Arial, sans-serif'}}>For Candidates</h3>
            <ul className="space-y-1">
              <li className="flex items-center text-white text-lg md:text-xl font-normal" style={{fontFamily: 'Inter, Helvetica, Arial, sans-serif'}}>
